...
namespace W4PLEGO\Base\Controller\Adminhtml\Image;

use W4PLEGO\Base\Model\ImageUploader;
 ...
 *
 * @package W4PLEGO\Base\Controller\Adminhtml\Image
 */
abstract class AbstractUpload extends BackendAction
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'W4PLEGO_Base::menu';
